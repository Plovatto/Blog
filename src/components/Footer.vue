...
<template>
<v-footer id="Contato" class="text-center bg-custom">
<v-container class="d-flex align-items-center justify-center ">
    <div class="cardzin">
  <a class="social-link1 mr-10" href="https://www.instagram.com/">
  ...
  <a class="social-link2 mr-10" href="https://twitter.com/i/flow/login?input_flow_data=%7B%22requested_variant%22%3A%22eyJsYW5nIjoicHQifQ%3D%3D%22%7D">
  ...
  <a class="social-link3 mr-10" href="https://discord.com/">
  ...
  <a class="social-link4" href="https://web.whatsapp.com/">
...
.cardzin .social-link2:hover {
  background-color: #00ccff;
  animation: bounce_613 0.4s linear;
}

.cardzin .social-link3:hover {
  background-color: #5865f2;
  animation: bounce_613 0.4s linear;
}

.cardzin .social-link4:hover {
